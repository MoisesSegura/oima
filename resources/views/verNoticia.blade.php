...
<div class="content">
    ...
    <!-- <img class="w-100 d-md-none" src="url('{{ asset('/uploads/' . ltrim($new->image, '/')) }}')" alt=""> -->

    <div class="hero hero-has-text hero--full"
        style="background-image:url('{{ asset('/uploads/' . ltrim($new->image, '/')) }}')">
        <div class="hero--txt">
