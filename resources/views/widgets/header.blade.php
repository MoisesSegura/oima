...
<html> 
    <head> 
        ...
        <title>OIMA | {{ ucfirst(request()->route()->getName()) }}</title>

        <link rel="apple-touch-icon" sizes="180x180" href="../apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="/uploads/uploads/oimaLogo.png">
        <link rel="icon" type="image/png" sizes="16x16" href="/uploads/uploads/oimaLogo.png">
