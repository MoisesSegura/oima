    ...
    <div class="container">
            ...
            <div class="sharebot ">
                ...
                <ul class="share--links">
                    <li><a class="share--link" target="_blank"
                            href="https://www.facebook.com/sharer/sharer.php?u=https://www.mioa.org/es/infoAgronomica/"><img
                                src="/img/fb-icon.svg"></a></li>
                    <li><a class="share--link" target="_blank"
                            href="https://wa.me/?text=https://www.mioa.org/es/infoAgronomica/"><img
                                src="/img/wa-icon.svg"></a></li>
                    <li><a class="share--link" target="_blank"
                            href="https://twitter.com/home?status=https://www.mioa.org/es/infoAgronomica/"><img
        ...
        <div class="row">
            <div class="col-md-4 d-none d-md-block text-center">
                ...
                @if ($productDetail->known_name)<h3 class="card--title">{{ $productDetail->known_name}}</h3> @endif
                        ...
                        <div class="card">
                            ...
                            <div id="collapse{{ $agronomicInformation->id }}" class="collapse"
                                ...
                                <div class="card-body txt--gray">
                                    <p style="text-align:justify">{!! __($agronomicInformation->text) ?? '' !!}</p> 
