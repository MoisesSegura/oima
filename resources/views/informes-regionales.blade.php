        ...
        <div class="container--repository open">
            ...
            <div>
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link document-category "
                            href="{{ route('documentos-tecnicos')}}"
                            id="document-cat-1">Documentos técnicos</a></li>
                    <li class="nav-item"><a class="nav-link document-category active"
                            href="{{ route('informes-regionales')}}"
                            id="document-cat-2">Informes regionales</a></li>
                </ul>
            </div>
            <div class="mt-1 mb-5">
