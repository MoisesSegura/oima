...
<!-- Mirrored from www.mioa.org/es/catalogo/Granos by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Oct 2023 23:26:41 GMT -->
<!-- Added by HTTrack -->
    ...
    <div class="nav" role="navigation">
        ...
        <ul class="nav__list">
            ...
            <li><a class="nav__list--link
                        active
            " href="{{ route('frutas')}}">Catálogo</a></li>
    ...
    <script>
        ...
        $("#more-results").on('click', function () {
            if (is_ajax === false) {
                is_ajax = true;
                $.ajax({
                    url: "/es/ajax/getProducts/5/" + page + "?" + query,
                    method: "GET"
                }).done(function (data) {
                    is_ajax = false;
                    page++;
