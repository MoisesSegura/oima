    ...
    <div class="nav--others">
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                <div class="backbot">
    <a href="/es/producto/banano/costa-rica" class="backbot--link"><i class="mdi mdi-chevron-left"></i> Volver</a>
</div>                <div class="sharebot ">
    <p class="sharebot--link"><i class="mdi mdi-share-variant"></i> Compartir</p>
    <ul class="share--links">
        <li><a class="share--link" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https://www.mioa.org/es/infoNutricional/banano/costa-rica"><img src="/img/fb-icon.svg"></a></li>
        <li><a class="share--link" target="_blank" href="https://wa.me/?text=https://www.mioa.org/es/infoNutricional/banano/costa-rica"><img src="/img/wa-icon.svg"></a></li>
        <li><a class="share--link" target="_blank" href="https://twitter.com/home?status=https://www.mioa.org/es/infoNutricional/banano/costa-rica "><img src="/img/tw-icon.svg"></a></li>
        <li><a class="share--link" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.mioa.org/es/infoNutricional/banano/costa-rica&title=&summary=&source="><img src="/img/li-icon.svg"></a></li>
    </ul>
</div>            </div>
            <div class="row">
                <div class="col-md-4 d-none d-md-block text-center">
                    <p class="card--text">Conocido como</p>
                    <h3 class="card--title">Banano</h3>
                    <img src="/uploads/products/images/551b766e0fde817b10a7451cfb4d03af7d76e67e.jpeg" alt="Banano" class="img-responsive">
                </div>
                <div class="col-md-8">
                    ...
                    <div class="content__container container">
                        <div class="row">
                                                        <div class="col-md-6">
                                                                    <h5 class="title title--sideline">Valor Nutricional</h5>
                                    <div class="txt--gray content--list">
                                        <p style="text-align:justify">El banano es una de las frutas m&aacute;s consumidas a nivel mundial. Es una fuente importante de carbohidratos, dentro de los cuales destaca el almid&oacute;n (en el banano verde) y az&uacute;cares como sacarosa, glucosa y fructosa en el banano maduro. Es una fruta rica en vitaminas y minerales, dentro de las cuales destacan: Vitamina B6, vitamina B2, vitamina C, vitamina E, potasio, magnesio y hierro. Los fitoqu&iacute;micos presentes en el banano son los carotenoides (alfa y beta caroteno, lute&iacute;na y zeaxantina).</p>

<p>&nbsp;</p>
                                    </div>
                                                                    <h5 class="title title--sideline">Propiedades nutricionales</h5>
                                    <div class="txt--gray content--list">
                                        <p style="text-align:justify">El banano es una excelente fuente de energ&iacute;a debido a su alto contenido en carbohidratos y a la presencia de vitaminas del complejo B.</p>

<p style="text-align:justify">Debido a su alto contenido en potasio, el banano puede actuar como coadyuvante en el tratamiento de afecciones cardiacas tales como arritmias, insuficiencia cardiaca, etc. Asimismo, el alto contenido de potasio y el pobre contenido de sodio contribuye en el tratamiento de la hipertensi&oacute;n arterial.</p>

<p style="text-align:justify">Debido su alto contenido en fibra, el banano contribuye en el tratamiento de afecciones gastrointestinales.</p>

<p>&nbsp;</p>
                                    </div>
                                                                    <h5 class="title title--sideline">Formas de preparación</h5>
                                    <div class="txt--gray content--list">
                                        <p>a. Crudo: esta es la forma ideal de consumir el banano, si &eacute;ste se acompa&ntilde;a con manzana resulta una preparaci&oacute;n &oacute;ptima para personas con afecciones intestinales.</p>

<p style="text-align:justify">b. En batido, s&oacute;lo o acompa&ntilde;ado con otras frutas y/o l&aacute;cteos.</p>
                                    </div>
