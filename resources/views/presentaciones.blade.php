...
@include('widgets.navbar')
            ...
            <div class="mt-1 mb-5">
                ...
                @foreach ($presentations as $presentation)
                    <div class="card--repository">
                        <img src="{{ asset($presentation->image) }}"
                            alt="Presentación Técnica: Presentación del Interfaz y Manual de Recolección de Precios  (MAG- DC- SIMA Paraguay)"
                            class="card__img">
    ...
    <script>
        ...
        $("#more-results").on('click', function () {
            if (is_ajax === false) {
                var url = "/es/ajax/repositorio/presentaciones/" + page + "?" + query
                is_ajax = true;
                $.ajax({
                    url: url,
                    method: "GET"
