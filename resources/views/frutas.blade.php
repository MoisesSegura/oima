<!DOCTYPE html> <html> <!-- Mirrored from www.mioa.org/es/catalogo/Frutas by HTTrack Website Copier/3.x [XR&CO'2014],
    Thu, 05 Oct 2023 23:23:05 GMT --> <!-- Added by HTTrack --><meta http-equiv="content-type"
...
<head> <meta charset="UTF-8">
    ...
    <title>OIMA | Catálogo
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="../../favicon-32x32.png"> <link rel="icon"
            type="image/png" sizes="16x16" href="../../favicon-16x16.png"> <link rel="manifest" href="../../site.html">
        <link rel="mask-icon" href="../../safari-pinned-tab.svg" color="#376697">
        <meta name="msapplication-TileColor" content="#ffffff"> <meta name="theme-color" content="#ffffff"> <link
            rel="stylesheet" type="text/css"
            href="../../../cdn.jsdelivr.net/npm/%40mdi/font%403.5.95/css/materialdesignicons.min.css"> <link
        ...
        <li><a class="nav__list--link active" href="Frutas.html">Catálogo</a></li>
        <li class=" d-none d-md-block"><a class="nav__list--link " href="{{ route('eventos')}}l">Blog</a></li>
        <li class="d-none d-md-block"><a class="nav__list--link " href="{{ route('contacto')}}">Contacto</a></li>

        <li class="nav-item dropdown d-md-none">
        <a id="nav-collapse-trigger" class="nav__list--link nav-link dropdown-toggle" href="#" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">Más <i class="mdi mdi-chevron-down"></i></a> <div
            class="dropdown-menu" aria-labelledby="nav-collapse-trigger">
            ...
            <div class="nav--others">
                <a class="text-decoration-none lang--select" href="http://www.mioa.org/en/catalogo/Frutas">EN</a>
                <a class="text-decoration-none lang--select" href="http://www.mioa.org/pt/catalogo/Frutas">PT</a>
                ...
                <form id="f_1" name="f_1">
                    <div class="search--container">
                        ...
                        <div class="input__wrap input__wrap--search">
                            <input class="input input--search" placeholder="Nombre de producto común o científico"
                                name="name" value="">
                        </div>
                    </div>
                </form>
                <div>
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item"><a href="{{ route('frutas')}}" class="nav-link active" id="cat3-tab"
                                aria-controls="cat3" aria-selected="true">Frutas</a></li>
                        ...
                        <li class="nav-item"><a href="{{ route('granos')}}" class="nav-link " id="cat5-tab"
                                aria-controls="cat5" aria-selected="false">Granos</a></li>

                        <li class="nav-item"><a href="" class="nav-link " id="cat6-tab" aria-controls="cat6"
            ...
            <div class="tab-content bg-white">
                <div class="tab-pane fade show active">
                    <div class="card__container js-equal-height-parent" id="products">
                        ...
                        @php
                        $product = \App\Models\ProductDetail::find($fruitDetail->id)->product;
                        @endphp
                        <a href="" class="card card--flex card--link js-equal-height">
                            ...
                            <div class="card--flex__content">
                                ...
                                <p class="card--text">{{ $fruitDetail->known_name }}</p>
            ...
            <script>
                ...
                $("#more-results").on('click', function () {
                    if (is_ajax === false) {
                        is_ajax = true;
                        $.ajax({
                            url: "/es/ajax/getProducts/3/" + page + "?" + query,
                            method: "GET"
                        }).done(function (data) {
                            is_ajax = false;
                            page++;
