...
class BibliographyRelationManager extends RelationManager
{
    protected static string $relationship = 'bibliography';

    public function getRelationship(): Builder | HasMany | BelongsTo
    {
