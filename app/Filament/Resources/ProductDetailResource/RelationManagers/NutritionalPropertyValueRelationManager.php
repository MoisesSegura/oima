...
class NutritionalPropertyValueRelationManager extends RelationManager
{
    protected static string $relationship = 'nutritionalPropertyValue';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->mountUsing(function (Forms\ComponentContainer $form, NutritionalPropertyValue $record) {
                    $data = [];
