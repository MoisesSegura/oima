...
use App\Models\NutritionalProperty;
use App\Models\NutritionalPropertyValue;
use Illuminate\Database\Eloquent\Relations\HasMany;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Filament\Forms\Components\Repeater;
use Filament\Forms\Components\Section;

class NutritionalPropertyRelationManager extends RelationManager
{
    protected static string $relationship = 'nutritionalProperty';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->mountUsing(function (Forms\ComponentContainer $form, NutritionalProperty $record) {
                    $data = [];
                ...
                ->form([ 
                    ...
                    // ->relationship('nutritionalPropertyValue')
                    // ->schema([
