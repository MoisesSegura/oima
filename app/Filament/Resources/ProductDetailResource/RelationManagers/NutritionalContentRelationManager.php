...
use App\Models\NutritionalContent;
use Illuminate\Database\Eloquent\Relations\HasMany;

class NutritionalContentRelationManager extends RelationManager
{
    protected static string $relationship = 'nutritionalContent';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->mountUsing(function (Forms\ComponentContainer $form, NutritionalContent $record) {
                    $data = [];
