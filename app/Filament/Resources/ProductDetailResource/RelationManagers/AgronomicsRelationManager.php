...
use App\Models\AgronomicInformation;
use Illuminate\Database\Eloquent\Relations\HasMany;

class AgronomicsRelationManager extends RelationManager
{
    protected static string $relationship = 'agronomics';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->mountUsing(function (Forms\ComponentContainer $form, AgronomicInformation $record) {
                    $data = [];
