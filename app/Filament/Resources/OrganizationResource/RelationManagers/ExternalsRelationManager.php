...
class ExternalsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->mountUsing(function (Forms\ComponentContainer $form, OrganizationExternal $record) {
                    $data = [];
