...
namespace App\Filament\Resources\OimaNewResource\RelationManagers;
...
use App\Models\OimaNewContent;
use Illuminate\Database\Eloquent\Relations\HasMany;

class OimaNewContentRelationManager extends RelationManager
{
    protected static string $relationship = 'oimaNewContent';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->mountUsing(function (Forms\ComponentContainer $form, OimaNewContent $record) {
                    $data = [];
